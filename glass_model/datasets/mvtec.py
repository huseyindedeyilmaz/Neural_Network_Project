...
class MVTecDataset(torch.utils.data.Dataset):
    ...
    def __init__(
            self,
            source,
            anomaly_source_path='/../../wood_dataset/wood/test/defect',
            dataset_name='wood_dataset',
            classname='wood',
            resize=288,
            imagesize=288,
        ...
        self.anomaly_source_paths = sorted(1 * glob.glob(anomaly_source_path + "/wood/test/defect/*.png") +
